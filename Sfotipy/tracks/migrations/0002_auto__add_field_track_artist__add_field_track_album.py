...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tracks_track', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['artists.Artist'], default=1),
                      keep_default=False)
    ...
    models = {
        ...
        'artists.artist': {
            ...
            'fist_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tracks.track': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'track': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        }
    }
